...
/// @ref https://www.shadertoy.com/view/MdyGzR
...
//	float cloudIntensity1 = 0.7 * (1.0-(2.5 * distance(uv, center)));
	float cloudIntensity1 = .5;
    float lighIntensity1 = .5; // 1.0/(100.0 * distance(uv,center));
	
	gl_FragColor = vec4( vec3(cloudIntensity1*clouds(uv))*lightColor1 + lighIntensity1 * lightColor1, 1.0 );
